...
if text == 'يابوت' and tonumber(msg.reply_to_message_id_) == 0 and not database:get(bot_id..'VAMBAIR:Lock:ID:Bot'..msg.chat_id_) then
if not database:sismember(bot_id..'VAMBAIR:Spam:Group'..msg.sender_user_id_,text) then
database:sadd(bot_id.."VAMBAIR:Spam:Group"..msg.sender_user_id_,text) 
tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = msg.sender_user_id_,offset_ = 0,limit_ = 1},function(extra,taha,success) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
if text == 'العاب مطوره' or text == 'العاب العزايزي' or text == 'العاب عمو اشرف' then  
local Text = [[  
◍ اليك قائمه الالعاب المطوره
...
{
{text = '◍ 𝗗𝗘𝗩 𝗔𝗦𝗥𝗔f .', url = "https://t.me/asera126"}
},
{
{text = '.²₀²₁ ˝₀₄˝₁₃ | ₁₂:₀₀ 𝗣𝗠 ◍', url = "https://t.me/BANDA1M"}
},
}
local msg_id = msg.id_/2097152/0.5
...
------------
if text == 'الالعاب' or text == 'العاب' or text == 'hle' then
local Text =[[
...
keyboard.inline_keyboard = {
{
{text = '◍ العاب السورس .', callback_data=msg.sender_user_id_.."/hle11"},
},
{
{text = '◍ العاب مطوره .', callback_data=msg.sender_user_id_.."/hle44"},{text = '5 ◍', callback_data=msg.sender_user_id_.."/hle55"},
},
{
{text = '. ²₀²₁ ˝₀₄˝₁₃ | ₁₂:₀₀ 𝙿𝙼 ◍', callback_data=msg.sender_user_id_.."/hle66"},
},
{
{text = '☊.رجوع.☊', callback_data=msg.sender_user_id_.."/homeaddrem"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/mmsst13/772&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
