...
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Kbard","Lock:geam","Lock:Ppmto","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Marmjaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
...
if text == 'بوت' and tonumber(msg.reply_to_message_id_) == 0 and not database:get(bot_id..'VAMBAIR:Llnk:ID:Bot'..msg.chat_id_) then
if not database:sismember(bot_id..'VAMBAIR:Spam:Group'..msg.sender_user_id_,text) then
database:sadd(bot_id.."VAMBAIR:Spam:Group"..msg.sender_user_id_,text) 
...
if text == 'تعين الايديتيخ تي' and Owner(msg) then
...
{
{text = '◍ العاب مطوره..🎮', callback_data=msg.sender_user_id_.."/hle11"},{text = '◍ العاب السورس..🎮', callback_data=msg.sender_user_id_.."/hle22"},
},
{
{text = '𝙰𝙻𝙰𝚉𝙸𝚉𝙰 𝙲𝙷𝙰𝙽𝙽𝙴𝙻⁦⁦', url="t.me/BANDA1M"}, 
},
}
...
{
{text = '𝙳𝙴𝚅 𝙰𝙻𝙰𝚉𝙸𝚉𝚈', url = "https://t.me/alazizy"},{text = '𝙳𝙴𝚅 𝙰𝚂𝚁𝙰f', url = "https://t.me/asera126"},
},
{
{text = '𝙰𝙻𝙰𝚉𝙸𝚉𝙰 𝙲𝙷𝙰𝙽𝙽𝙴𝙻⁦⁦', url = "https://t.me/BANDA1M"},
},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'تايسون' or text == 'ياتيسون' or text == 'TAESoN' or text == '"' then
local Text =[[
◍ يايسون مطوري حبيبي التواصل
◍ عن طريق معرفه في الاسفل ↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
{
{text = 'TAESoN🇪🇬', url = "https://t.me/K_I_N_G_B_O_D_Y"}
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/mmsst13/773&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
