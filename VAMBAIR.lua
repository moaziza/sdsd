...
{
{text = '☊.العاب مطوره.☊', callback_data=msg.sender_user_id_.."/yar22"},
},
{
{text = '☊.العاب السورس.☊', callback_data=msg.sender_user_id_.."/yar11"},
},
{
...
if Text and Text:match('(.*)/yar11') then
if tonumber(Text:match('(.*)/yar11')) == tonumber(data.sender_user_id_) then
local Teext =[[
◍ قائمه العاب السورس
──┈┈┈┄┄╌╌╌╌┄┄┈┈┈
...
if Text and Text:match('(.*)/yar22') then
if tonumber(Text:match('(.*)/yar22')) == tonumber(data.sender_user_id_) then
local Teext =[[
