...
------------
if text == 'الالعاب' or text == 'orders' or text == 'hle' then
local Text =[[
...
keyboard.inline_keyboard = {
{
{text = '◍ العاب السورس .', callback_data=msg.sender_user_id_.."/hle11"},{text = '◍ العاب مطوره .', callback_data=msg.sender_user_id_.."/hle22"},
},
{
{text = '◍ ²₀²₁ ˝₀₄˝₁₃ | ₁₂:₀₀ 𝙿𝙼 ◍', url="https://t.me/UUOOO_BOT?startgroup=new"}, 
},
}
local msg_id = msg.id_/2097152/0.5
