...
if text == "قفل الدرتتتتتتتتدشه" and msg.reply_to_message_id_ == 0 and Owner(msg) then 
database:set(bot_id.."VAMBAIR:Lock:text"..msg.chat_id_,true) 
Reply_Status(msg,msg.sender_user_id_,"lock","◍ تم قفـل الدردشه")  
return false
end 
if text == "قفل الاررززضافه" and msg.reply_to_message_id_ == 0 and Addictive(msg) then 
...
if text == "قفل التعورررديل" and msg.reply_to_message_id_ == 0 and Constructor(msg) then 
database:set(bot_id.."VAMBAIR:Lock:edit"..msg.chat_id_,true) 
Reply_Status(msg,msg.sender_user_id_,"lock","◍ تم قفـل تعديل")  
return false
end 
if text == "قفل تعديل ررررالميديا" and msg.reply_to_message_id_ == 0 and Constructor(msg) then 
database:set(bot_id.."VAMBAIR:Lock:edit"..msg.chat_id_,true) 
Reply_Status(msg,msg.sender_user_id_,"lock","◍ تم قفـل تعديل")  
return false
end 
if text == "قفل الورركل" and msg.reply_to_message_id_ == 0 and Constructor(msg) then  
...
if text == "فتح التعدورريل" and msg.reply_to_message_id_ == 0 and Constructor(msg) then 
database:del(bot_id.."VAMBAIR:Lock:edit"..msg.chat_id_) 
Reply_Status(msg,msg.sender_user_id_,"unlock","◍ تم فـتح تعديل")  
return false
end 
if text == "فتح التعديررتتل الميديا" and msg.reply_to_message_id_ == 0 and Constructor(msg) then 
database:del(bot_id.."VAMBAIR:Lock:edit"..msg.chat_id_) 
Reply_Status(msg,msg.sender_user_id_,"unlock","◍ تم فـتح تعديل")  
return false
end 
if text == "فتح رررررالكل" and msg.reply_to_message_id_ == 0 and Addictive(msg) then 
...
if text == "قفمممممل السيلفي بالكتم" and Addictive(msg) then
...
if text == "قفممممممل السيلفي بالطرد" and Addictive(msg) then
...
if text == "قفل الماركنننننداون بالكتم" and Addictive(msg) then
...
if text == "قفلررروو الماركداون بالطرد" and Addictive(msg) then
...
if text == "قفووووول التكرار" and Addictive(msg) then 
...
if text == "قفننتتنل التكرار بالتقييد" and Addictive(msg) then 
...
if text == "قفتتننل التكرار بالكتم" and Addictive(msg) then 
...
if text == "فتتتتتح التكرار" and Addictive(msg) then 
...
ReplyStatus(msg,result.sender_user_id_,"Reply","  ")  
end 
