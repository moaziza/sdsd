...
-----------
if text == 'العاب' or text == 'عزايزي' or text == 'مصطفي محمد' or text == '"' then
local Text =[[
──┈┈┈┄┄╌╌╌╌┄┄┈┈┈
◍ قم بأختيار اللغه.. ↑↓
◍ Choose language.. ↑↓ 
...
keyboard.inline_keyboard = {
{
{text = 'العاب مطورن 𝅘𝅥𝅮', callback_data=msg.sender_user_id_.."/helmp1"}, {text = 'العاب سورس 𝅘𝅥𝅮', callback_data=msg.sender_user_id_.."/help"}, 
},
{
...
if Text and Text:match('(.*)/helmp1') then
if tonumber(Text:match('(.*)/helmp1')) == tonumber(data.sender_user_id_) then
local Teext =[[
◍ قائمة اوامر الحماية..↑↓
──┈┈┈┄┄╌╌╌╌┄┄┈┈┈
