...
keyboard.inline_keyboard = {
{
{text = 'العاب مطورن 𝅘𝅥𝅮', callback_data=msg.sender_user_id_.."/hllep"}, {text = 'العاب سورس 𝅘𝅥𝅮', callback_data=msg.sender_user_id_.."/hellp"}, 
},
{
...
if Text and Text:match('(.*)/hllep') and Addictive(tahaj) then
if tonumber(Text:match('(.*)/hllep')) == tonumber(data.sender_user_id_) then
local Teext =[[
العاب مطوره
──┈┈┈┄┄╌╌╌╌┄┄┈┈┈
اتفضل 
