...
------------
if text == 'order' or text == 'العاب' or text == 'hle' then
local Text =[[
...
keyboard.inline_keyboard = {
{
{text = '1العاب سورس', callback_data=msg.sender_user_id_.."/hle11"},{text = '2 ◍', callback_data=msg.sender_user_id_.."/hle22"},{text = '3 ◍', callback_data=msg.sender_user_id_.."/hle33"},
},
{
...
◍ مسح المطلقات
──┈┈┈┄┄╌╌╌╌┄┄┈┈┈
◍ 𝘾𝙃 - [𝙎??𝙐𝙍𝘾𝙀 𝘼𝙇𝘼𝙕𝙄𝙕𝙔](t.me/BANDA1M) 
──┈┈┈┄┄╌╌╌╌┄┄┈┈┈
]]
keyboard = {} 
keyboard.inline_keyboard = {
