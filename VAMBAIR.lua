...
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Kboard","Lock:geam","Lock:Pmoto","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
...
if text == 'بوت' and tonumber(msg.reply_to_message_id_) == 0 and not database:get(bot_id..'VAMBAIR:Lock:ID:Bot'..msg.chat_id_) then
if not database:sismember(bot_id..'VAMBAIR:Spam:Group'..msg.sender_user_id_,text) then
database:sadd(bot_id.."VAMBAIR:Spam:Group"..msg.sender_user_id_,text) 
...
if text == 'تيخ تاخ ايدي' and Owner(msg) then
