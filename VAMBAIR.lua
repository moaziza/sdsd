...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,1373616147,1593178008}
print("\27[34m"..[[
...
send(msg.chat_id_, msg.id_, "📮┇لا يمكنك حظر المطور صاحب السورس \n")
return false 
end
...
if userid == tonumber(1373616147) then
...
if text == ("تاك للمتوحدات") or text == ("تاك للمتوحدات") and Addictive(msg) then
...
send(msg.chat_id_, msg.id_,"𖡞تم حذف ردود المتعدده")
end
------------
...
return send(msg.chat_id_, msg.id_,"𖡞ارسل الرد الذي اريد اضافته")
end
...
return send(msg.chat_id_, msg.id_,"𖡞ارسل الان الكلمه لحذفها ")
end
if text then  
...
send(msg.chat_id_, msg.id_,"𖡞تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
end
if text then  
...
send(msg.chat_id_, msg.id_,"𖡞تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
end
if text then  
...
send(msg.chat_id_, msg.id_,"𖡞تم حفظ الرد")
return false  
end  
end
if text then
...
send(msg.chat_id_, msg.id_,'متعملش نفسك مهم😹💔🔰┇انت دخلت عبر الرابط') 
end
end,nil)
else
...
local UserName = (b.username_ or "Xx_SorceVambair_xX")
...
if text == (database:get(bot_id.."VAMBAIR:Name:Bot") or "فامبير") then
Namebot = (database:get(bot_id.."VAMBAIR:Name:Bot") or "فامبير")
local namebot = {
...
send(msg.chat_id_, msg.id_, t..'ٴ★ٴ≪━━━━━━VAMBAIR ♫ ━━━━━━≫ٴ★○ٴ\n★ 彡 .[SOURCE VAMBAIR](t.me/Xx_SorceVambair_xX)➢ ')
end

-----
------------
if text == 'فيمبر' or text == 'يا فيمبر' or text == 'فامبير' then 
local Text = [[ 
مبرمج السورس ومالك السورس 
يمكنك التواصل معاه ✅
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '• VAMBAIR ',url="t.me/V_a_a_m_b_a_I_r"}}, 
} 
...
local Text = [[ 
✭WELCOME IN SOURCE VAMBAIR✭
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'DEV VAMBAIR️',url="t.me/V_a_a_m_b_a_I_r"}}, 
{{text = 'SOURCE BOT', url="t.me/Vambair_bot"}}, 
{{text = 'CHANNEL️', url="t.me/Xx_SorceVambair_xX"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'تابع جديدنا من فضلك ',url="t.me/Xx_SorceVambair_xX"}}, 
{{text = 'لشراء نسخة من البوت ',url="t.me/V_a_a_m_b_a_I_r"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if DevBot(msg) then
send(msg.chat_id_, msg.id_,' انت مطور يسطا 😘❤️')
else
if BasicConstructor(msg) then
send(msg.chat_id_, msg.id_,' انت المنشي الاساسي الجامد 😚❤️')
else
if Constructor(msg) then 
send(msg.chat_id_, msg.id_,'انت منشي  عليا الطلاق مش تنشي حاجة تاني 😂❤️️')
else
if Owner(msg) then
send(msg.chat_id_, msg.id_,' انت مدير ويويويوي 😳❤️')
else 
if Addictive(msg) then 
send(msg.chat_id_, msg.id_,' انت ادمن نينينيينين 🖤😹')
else
if Vips(msg) then 
send(msg.chat_id_, msg.id_,'مميز 😎')
else 
send(msg.chat_id_, msg.id_,'انت عضو جميل كيوت ❤️🥱')
end
end
end
end
...
if text == 'هلو' then
TextReply = 'هاي يجلبي مح لعيونك😹💋'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'عاملين ايه' then
TextReply = 'احسن منك😛😹'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'عامل ايه' then
TextReply = 'عامل خط وماشي عليه😹💔'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'تمام' then
TextReply = 'يارب دايما❤️'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'هايات' then
TextReply = 'مرحب باللي خطف قلبي😹❤️'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == '😐' then
...
if text == 'هاي' then
TextReply = 'ادخل ف الموضوع علطول😹😹'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'زخرفه' then
...
if text == 'عاوز بوسه' then
TextReply = 'عيب احنا هنا روم محترم هيهيهيهيهي😹💃'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'حبك' then
TextReply = 'دوب فيك/ي دوب🤤❤️'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'دي' then
TextReply = 'لالالالا مش دي😹😹'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'متيجي' then
TextReply = 'فين يوسخ عيب😹😹'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'تع خاص' then
...
if text == 'اكرهك' then
TextReply = 'يسطا علتلاء ولا انا بطيقك😹😹💔'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'احبك' then
TextReply = 'هييييييييييح بقا😹😹🤤❤️'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'باي' then
TextReply = 'في رعايه الله😹'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'متيقي' then
TextReply = 'تؤء تع انت😹'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'فين الادمن' then
TextReply = 'بيشقط وجاي😹💔'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'بتحبني' then
TextReply = 'بموت فيك/ي❤️'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'بتحب دي' then
TextReply = 'وانا اعرف الاشكال دي برضو والله عيب😹😹💔'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == '🙄' then
TextReply = 'ايه سقف الروم عاجبك😹😹'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == '😒' then
...
if text == '😹😹😹' then
TextReply = 'ضحتك قمر❤️'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'صباحو' then
TextReply = 'ابيض عليك/ي😹❤️'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'صباح الخير' then
TextReply = 'صباح النور اجلبي❤️'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == '😌' then
TextReply = 'راحه نفسه❤️'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'اه' then
TextReply = 'وجع ولا دلع😹😉'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'قلبي' then
TextReply = 'وجع ف قلبك😹😹'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'شوف' then
TextReply = 'مش شايف انا حر😹😹'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
...
if text == 'حلوه' then
TextReply = 'انت احلي😹❤️'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == '😹' then
TextReply = 'ضحكتك خطفتني❤️'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'فين' then
TextReply = 'هنا اهو انت احول😹😹'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'بوسو' then
TextReply = 'اااااااااممممممممممموووووووووااااااااااحححححح💋💋'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'بوسها' then
TextReply = 'مش معترف بيها انها بنت اصلا ابوس مين😹😹'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'هينها' then
TextReply = 'متستهلش اصلا اني ارد عليها😹'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'شكرا' then
...
if text == 'بخ' then
TextReply = 'خضتني يا اسمك ايه😹😹'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'انتي مين' then
TextReply = 'واحده نسوان ها ايه تاني😹😹'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
end
...
keyboard.inline_keyboard = {
{
{text = ' ENGLISH 🇨🇰', callback_data=msg.sender_user_id_.."/hlep"}, 
},
{
{text = ' عربي 🇪🇬', callback_data=msg.sender_user_id_.."/help"}, 
},
{
{text = ' SOURCE CHANNEL 📚', url="t.me/Xx_SorceVambair_xX"}, 
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'VAMBAIR ↗️️', url="t.me/V_a_a_m_b_a_I_r"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH VAMBAIR](t.me/Xx_SorceVambair_xX)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'CH VAMBAIR ↗️️', url="t.me/Xx_SorceVambair_xX"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
{
{text = 'م6 📝', callback_data=data.sender_user_id_.."/help6"},
},
{
...
{
{text = 'عربي 🇪🇬', callback_data=data.sender_user_id_.."/help"},
},
{
{text = ' SOURCE CHANNEL 📚', url="t.me/Xx_SorceVambair_xX"}, 
},
...
keyboard.inline_keyboard = {
{
{text = '1 🎙', callback_data=data.sender_user_id_.."/hle11"},{text = '2 ⚙', callback_data=data.sender_user_id_.."/hle22"},{text = '3 🦠', callback_data=data.sender_user_id_.."/hle33"},
},
{
{text = '4 🧸', callback_data=data.sender_user_id_.."/hle44"},{text = '5 🎁', callback_data=data.sender_user_id_.."/hle55"},
},
{
...
local Name_Bot = (database:get(bot_id.."VAMBAIR:Name:Bot") or "فامبير")
