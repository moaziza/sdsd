...
◍ لعبة البـات ← بات
──┈┈┈┄┄╌╌╌╌┄┄┈┈┈
◍ 𝘾𝙃 - [𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝘼𝙕𝙄𝙕𝙔](t.me/Xx_SorceVambair_xX)
──┈┈┈┄┄╌╌╌╌┄┄┈┈┈
]]
...
{
{text = '◍ D𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 𖣌', url = "https://t.me/UU_Fs"},{text = '◍ D𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 𖣌', url = "https://t.me/UU_Dev"},
},
{
{text = '◍ M𝚈 𝙲𝙷𝙰𝙽𝙽𝙴𝙻𝚂 𖣌', url = "https://t.me/Source_Queen"}
},
{
{text = '²₀²₁ ˝₀₄˝₁₃ | ₁₂:₀₀ 𝙿𝙼', url = "https://t.me/FlassTas10"}
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/mmsst13/747&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
------------
...
TextReply = '◍ عيب الروم ده طاهر وهيفضل طول عمره طاهر..🙄💔'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'بحبك' then
...
TextReply = '◍ انا وحده نسوان ونت مين..😂💘'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
end
