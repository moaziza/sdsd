...
if text == 'العاب' or text == 'الالعاب' or text == '/hle' then
local Text =[[
...
{
{text = '☊.العاب مطوره.☊', callback_data=msg.sender_user_id_.."/hlle11"},
},
{
{text = '☊.العاب السورس.☊', callback_data=msg.sender_user_id_.."/llle11"},
},
{
...
if Text and Text:match('(.*)/hlle11') then
if tonumber(Text:match('(.*)/hlle11')) == tonumber(data.sender_user_id_) then
local Teext =[[
khshshshshdhdhs
...
if Text and Text:match('(.*)/llle11') then
if tonumber(Text:match('(.*)/llle11')) == tonumber(data.sender_user_id_) then
local Teext =[[
khshshshshdhdhs
◍ اهلا بك في قسم العاب مطوره..🎮
◍ من فضلك اختار اللعبه وثم ..🎮
