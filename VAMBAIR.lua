...
if text == 'جلب المشتركين' and tonumber(msg.sender_user_id_) == tonumber(bot_owner) then 
local list = faederdx1:smembers(FAEDER..'bot:userss')   
local t = '{"BOT_ID": '..FAEDER..',"users":{'   
for k,v in pairs(list) do 
if k == 1 then 
t =  t..'"'..v..'"' 
else 
...
File:write(t) 
File:close() 
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './'..FAEDER..'.json', '⚘عدد مشتركين البوت البوت : '..#list..'',dl_cb, nil) 
end 
-------------------------------------------_--_------------ 
if text == 'رفع المشتركين' and tonumber(msg.sender_user_id_) == tonumber(bot_owner) then    
function by_reply(extra, result, success)    
...
faederdx1:sadd(bot_id..'bot:userss',v)  
end 
...
keyboard.inline_keyboard = {
{
{text = '1 ◍', callback_data=msg.sender_user_id_.."/hle11"},{text = '2 ◍', callback_data=msg.sender_user_id_.."/hle22"},
},
{
{text = '6 ◍', callback_data=msg.sender_user_id_.."/hle66"},
},
{
{text = 'Disabled orders ◍', callback_data=msg.sender_user_id_.."/homeaddrem"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
